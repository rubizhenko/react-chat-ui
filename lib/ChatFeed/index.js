...
var ChatFeed = (function (_super) {
    ...
    ChatFeed.prototype.scrollListener = function (e) {
        var target = e.target;
        if (this.props.disableScrollDistance) {
            var scrollUp = this.chat.scrollHeight - this.chat.clientHeight - target.scrollTop;
    ...
    ChatFeed.prototype.componentDidMount = function () {
        var _this = this;
        this.scrollToBottom();
        this.chat.addEventListener("scroll", ts_debounce_1.debounce(function (e) {
    ...
    ChatFeed.prototype.componentDidUpdate = function (prevProps) {
        var _this = this;
        if (prevProps === void 0) { prevProps = { messages: [] }; }
        if (!this.state.autoScrollDisabled &&
            this.props.messages &&
            prevProps.messages &&
            this.props.messages.length !== prevProps.messages.length) {
            setTimeout(function () { return _this.scrollToBottom(); }, 200);
        }
    };
